    ...
    <div class="player">
        ...
        <div class="player__play" @click.prevent="play">
            <a id="play" href="#" title="Play">
                <svg width="35px" height="35px" viewBox="0 0 35 35" :class="{'player--active': isPlaying}"
                        ...
                        <g id="Layout" transform="translate(-517.000000, -96.000000)">
                            <g id="Control-bar" transform="translate(0.000000, 90.000000)">
                                <g id="Player" transform="translate(377.000000, 4.000000)">
                                    <path d="M157.142878,2.57139111 C166.607175,2.57139111 174.285755,10.2499717 174.285755,19.7142687 C174.285755,29.1785657 166.607175,36.8571463 157.142878,36.8571463 C147.678581,36.8571463 140,29.1785657 140,19.7142687 C140,10.2499717 147.678581,2.57139111 157.142878,2.57139111 Z M165.714316,20.9419487 C166.160745,20.6964127 166.428603,20.2276622 166.428603,19.7142687 C166.428603,19.2008752 166.160745,18.7321247 165.714316,18.4865886 L153.571445,11.343723 C153.147337,11.0758655 152.589301,11.0758655 152.142872,11.3214015 C151.696443,11.589259 151.428585,12.0580096 151.428585,12.571403 L151.428585,26.8571343 C151.428585,27.3705278 151.696443,27.8392784 152.142872,28.1071358 C152.366086,28.2187431 152.611622,28.2857075 152.857158,28.2857075 C153.102694,28.2857075 153.34823,28.2187431 153.571445,28.0848144 L165.714316,20.9419487 Z"
                                          class="play-path"></path>
                                </g>
                            </g>
                        </g>
                    </g>
        ...
        <div class="player__pause" @click.prevent="pause">
            <a id="pause" href="#" title="Pause">
                <svg width="18px" height="18px" viewBox="0 0 18 18" :class="{'player--active': isPaused}"
                     class="player__button">
                    <g id="Visual-Player">
        ...
        <div class="player__save"
             @click.prevent="toggleModal"
             v-if="this.user"
             :data-balloon="saveMessage"
